...
import OldoinyoLengaiEnhancedSections from '../components/OldoinyoLengaiEnhancedSections'
import MountainRoutesSection from '../components/MountainRoutesSection'

export default function OldoinyoLengaiOverview() {
    ...
    <div className="bg-[#faf8f3] min-h-screen">
      ...
      <section ref={heroRef} className="relative min-h-[70vh] sm:min-h-[80vh] flex flex-col justify-end bg-green-950 overflow-hidden">
        <div className="absolute inset-0">
          <img
            src="/images/sections/oldoinyo-lengai-hero.jpg"
            alt="Oldoinyo Lengai volcano Tanzania"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 pt-28 pb-16">
          <div className="flex items-center gap-2 font-sans text-xs text-white/50 mb-6">
            ...
            <Link to="/trekking" className="hover:text-white/80 transition-colors">Mountain Climbing</Link>
            <ChevronRight size={12} />
            <span className="text-white/70">Oldoinyo Lengai</span>
          </div>
          ...
          <div className="max-w-3xl">
            ...
            >
              Tanzania's Sacred Mountain of God · 2,962m
            </motion.p>
            <motion.h1
            ...
            >
              Tanzania's legendary "Mountain of God" — an active volcano trek unlike anywhere on Earth. A midnight ascent through the Great Rift Valley to a steaming crater rim, with sunrise spreading across Lake Natron far below. Guided by Nelson Tours and Safaris, this is the adventure that will define your Tanzania experience.
            </motion.p>
            ...
            >
              ...
              >
                Plan My Trek <ArrowRight size={16} />
              </a>
              <a
                href="#itinerary"
      ...
      <div className="bg-white shadow-sm border-b border-gray-100">
        <div className="max-w-5xl mx-auto px-6 lg:px-8 py-4">
          <div className="flex flex-wrap gap-x-8 gap-y-3 justify-center sm:justify-start">
            {[
              { label: 'Summit', val: 'Crater Rim' },
              { label: 'Elevation', val: '2,962m' },
              { label: 'Location', val: 'Near Lake Natron, Rift Valley' },
              { label: 'Trek Duration', val: '7–12 Hours' },
              { label: 'Best Season', val: 'Jun–Oct & Dec–Feb' },
            ].map(s => (
      ...
      {/* Ol Doinyo Lengai routes from DB */}
      <MountainRoutesSection
        mountain="lengai"
        title="Ol Doinyo Lengai Trek Packages"
        subtitle="Our carefully designed Lengai packages combine the midnight summit ascent with the full Lake Natron wilderness experience. Private departures only."
      />

      {/* 10-section enhanced content */}
      <OldoinyoLengaiEnhancedSections />

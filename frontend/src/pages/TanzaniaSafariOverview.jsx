...
import SafariEnhancedSections from '../components/SafariEnhancedSections'

export default function TanzaniaSafariOverview() {
  ...
  return (
    <div className="bg-[#faf8f3] min-h-screen">
      ...
      <section ref={heroRef} className="relative min-h-[70vh] sm:min-h-[80vh] flex flex-col justify-end bg-green-950 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 pt-28 pb-16">
          ...
          <div className="flex items-center gap-2 font-sans text-xs text-white/50 mb-6">
            ...
            <span className="text-white/70">Tanzania Safari</span>
          </div>
          ...
          <div className="max-w-3xl">
            ...
            >
              East Africa's Premier Wildlife Destination
            </motion.p>
            <motion.h1
            ...
            >
              Home to the Serengeti, the Great Migration, and some of the densest wildlife populations on Earth. Nelson Tours and Safaris guides you into the heart of Africa's greatest wild places — safely, authentically, and unforgettably.
            </motion.p>
      ...
      <AnimatePresence>
        {showSticky && (
          ...
          >
            ...
            >
              Explore Safari Tours <ArrowRight size={14} />
            </Link>
            <a
              href="https://wa.me/255750005973"
              target="_blank"
      ...
      <div className="bg-white shadow-sm border-b border-gray-100">
        <div className="max-w-5xl mx-auto px-6 lg:px-8 py-4">
          <div className="flex flex-wrap gap-x-8 gap-y-3 justify-center sm:justify-start">
            {[
              { label: 'Top Parks', val: 'Serengeti, Ngorongoro, Tarangire' },
              { label: 'Wildlife', val: 'Big Five + Great Migration' },
              { label: 'Safari Duration', val: '3–10+ Days' },
              { label: 'Best Seasons', val: 'Jun–Oct & Jan–Mar' },
              { label: 'Entry Gateway', val: 'Kilimanjaro Int\'l Airport' },
            ].map(s => (
      ...
      {/* ── 11-section enhanced content ──────────────────────────────────────── */}
      <SafariEnhancedSections />

...
import MeruEnhancedSections from '../components/MeruEnhancedSections'
import MountainRoutesSection from '../components/MountainRoutesSection'

export default function MountMeruOverview() {
  ...
  return (
    <div className="bg-[#faf8f3] min-h-screen">
      ...
      <section ref={heroRef} className="relative min-h-[70vh] sm:min-h-[80vh] flex flex-col justify-end bg-green-950 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 pt-28 pb-16">
          <div className="flex items-center gap-2 font-sans text-xs text-white/50 mb-6">
            ...
            <ChevronRight size={12} />
            <span className="text-white/70">Mount Meru</span>
          </div>
          ...
          <div className="max-w-3xl">
            ...
            >
              Tanzania's wildest volcano trek winds through Arusha National Park's wildlife-rich rainforest to the dramatic summit of Socialist Peak  with Kilimanjaro rising above the clouds at dawn. Guided by Nelson Tours and Safaris, your Meru expedition starts the moment you say yes.
            </motion.p>
            ...
            >
              ...
              >
                Plan My Climb <ArrowRight size={16} />
              </a>
              <a
                href="#why-meru"
      ...
      <AnimatePresence>
        {showSticky && (
          ...
          >
            ...
            >
              Plan My Climb <ArrowRight size={14} />
            </a>
            <a
              href="#why-meru"
      ...
      <div className="bg-white shadow-sm border-b border-gray-100">
        <div className="max-w-5xl mx-auto px-6 lg:px-8 py-4">
          <div className="flex flex-wrap gap-x-8 gap-y-3 justify-center sm:justify-start">
            {[
              { label: 'Summit', val: 'Socialist Peak' },
              { label: 'Elevation', val: '4,566m' },
              { label: 'Location', val: 'Arusha National Park' },
              { label: 'Duration', val: '3–4 Days' },
      ...
      {/* Mount Meru routes from DB */}
      <MountainRoutesSection
        mountain="meru"
        title="Mount Meru Routes & Packages"
        subtitle="Choose your ideal Mount Meru trekking package. Every departure is private, fully supported, and guided by our certified local team."
      />

      {/* 10-section enhanced content */}
      <MeruEnhancedSections />

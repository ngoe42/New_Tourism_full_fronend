    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <Link to="/" className="flex-shrink-0 flex items-center justify-start relative w-[210px] sm:w-[300px] h-full" aria-label="Nelson Tours and Safari — Home">
            <img
              src="/images/logo/logo.png"
              alt="Nelson Tours & Safari"
              className={`h-24 sm:h-36 w-auto object-contain transition-all duration-500 origin-top-left z-10 ${

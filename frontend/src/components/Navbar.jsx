      ...
      <div className={`bg-green-950 overflow-hidden transition-all duration-500 ${
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 ml-auto">
            <a href="https://www.facebook.com/nelson.michael.39" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-white/50 hover:text-white transition-colors"><Facebook size={13} /></a>
              ...
              <div className="flex-shrink-0 bg-white border-t border-gray-100 px-4 py-4 space-y-2.5">
                ...
                <div className="flex items-center justify-center gap-5 pt-1">
                  {[
                    ...
                    { href: 'https://www.facebook.com/nelson.michael.39', label: 'Facebook', icon: <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5"><path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"/></svg> },

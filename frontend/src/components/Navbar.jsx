    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <Link to="/" className={`flex-shrink-0 flex items-center justify-center transition-all duration-300 overflow-hidden ${isTransparent ? 'bg-white/95 rounded-xl shadow-md' : ''} w-[240px] h-[80px]`} aria-label="Nelson Tours and Safari — Home">
            <img
              src="/images/logo/logo.png"
              alt="Nelson Tours & Safari"
              className="w-full h-full object-cover scale-[1.65] origin-center"
            />
          </Link>
